...
export const RESET_COMPETITIVE_JOBS = PREFIX + 'RESET_COMPETITIVE_JOBS';
export const UPDATE_FILTER = PREFIX + 'UPDATE_FILTER';
export const UPDATE_OFFSET = PREFIX + 'UPDATE_OFFSET';
...
export const HIDE_INPUT_PATHS = PREFIX + 'HIDE_INPUT_PATHS';
export const UPDATE_FILTER_COUNTERS = PREFIX + 'UPDATE_FILTER_COUNTERS';
