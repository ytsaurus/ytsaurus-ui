...
export const UPDATE_TITLE = `${GLOBAL_PREFIX}UPDATE_TITLE` as const;
export const BLOCK_USER = `${GLOBAL_PREFIX}BLOCK_USER` as const;
export const BAN_USER = `${GLOBAL_PREFIX}BAN_USER` as const;
export const INC_NAV_BLOCKER_COUNTER = `${GLOBAL_PREFIX}INC_NAV_BLOCKER_COUNTER` as const;
export const DEC_NAV_BLOCKER_COUNTER = `${GLOBAL_PREFIX}DEC_NAV_BLOCKER_COUNTER` as const;
export const SPLIT_SCREEN = `${GLOBAL_PREFIX}SPLIT_SCREEN` as const;
export const MERGE_SCREEN = `${GLOBAL_PREFIX}MERGE_SCREEN` as const;
...
export const UPDATE_CLUSTER = {
    ...
    FINAL_SUCCESS: `${GLOBAL_PREFIX}_UPDATE_CLUSTER_FINAL_SUCCESS` as const,
};
