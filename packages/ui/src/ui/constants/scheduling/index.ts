...
export const SCHEDULING_EXPANDED_POOLS_REQUEST = 'SCHEDULING_EXPANDED_POOLS_REQUEST';
export const SCHEDULING_EXPANDED_POOLS_SUCCESS = 'SCHEDULING_EXPANDED_POOLS_SUCCESS';
export const SCHEDULING_EXPANDED_POOLS_FAILURE = 'SCHEDULING_EXPANDED_POOLS_FAILURE';
export const SCHEDULING_EXPANDED_POOLS_CANCELLED = 'SCHEDULING_EXPANDED_POOLS_CANCELLED';
export const SCHEDULING_EXPANDED_POOLS_PARTITION = 'SCHEDULING_EXPANDED_POOLS_PARTITION';
...
export const SCHEDULING_ALLOWED_ROOT_TABS = {
    ...
    [SchedulingTab.PROMETHEUS_DASHBOARD]: true,
};
