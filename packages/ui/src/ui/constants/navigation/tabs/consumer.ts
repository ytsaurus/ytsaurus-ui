...
export const CONSUMER_CHANGE_PERSISTED_STATE = 'CONSUMER_CHANGE_PERSISTED_STATE';

export const CONSUMER_CHANGE_PARTITIONS_COLUMNS = 'CONSUMER_CHANGE_PARTITIONS_COLUMNS';
