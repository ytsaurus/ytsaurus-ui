...
import {SchedulingTab as SchedulingTab} from '../constants/scheduling';
...
export const getMainLocations = (): Array<[string, PathParameters]> => [
    ...
    [`/*/${Page.SCHEDULING}/${SchedulingTab.PROMETHEUS_DASHBOARD}`, [schedulingMonitoringParams, getSchedulingMonitoringParams]],
