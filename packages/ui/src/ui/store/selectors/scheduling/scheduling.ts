...
export const getSortState = createSelector([getSortStateRaw, getCurrentPool], schedulintSortState);
...
export function schedulintSortState(sortState: OldSortState, pool?: {mode?: 'fifo' | string}) {
