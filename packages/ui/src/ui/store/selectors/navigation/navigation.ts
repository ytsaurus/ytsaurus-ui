...
export const getNavigationOriginatingQueuePath = (state:RootState) => state.navigation.navigation.originatingQueuePath;

export const getSupportedTabs = createSelector(
    [getNavigationPathAttributes, getTableMountConfigHasData, getTabletErrorsBackgroundCount, getNavigationOriginatingQueuePath],
    (attributes, mountConfigHasData, tabletErrorsCount, originatingQueuePath) => {
        console.log(originatingQueuePath)
...
export const getTabs = createSelector(
    [getSupportedTabs, getTabletErrorsBackgroundCount, getAttributes, getNavigationOriginatingQueuePath, getCluster],
