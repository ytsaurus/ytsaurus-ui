...
export const ConfigWizard: FC = () => {
    ...
    return (
        <div className={b()}>
            <Text variant="subheader-1">{i18n('title_chart-config')}</Text>
            <TextInput
                placeholder={i18n('field_chart-title')}
                name="title"
            ...
            />
            <TextInput
                placeholder={i18n('field_x-title')}
                name="xTitle"
            ...
            />
            <TextInput
                placeholder={i18n('field_y-title')}
                name="yTitle"
            ...
            />
            <Checkbox
                content={i18n('field_show-legend')}
                name="legend"
