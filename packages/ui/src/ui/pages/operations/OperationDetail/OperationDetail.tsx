...
import {selectIsIncarnationNextFeature} from '../../../store/selectors/settings/settings-development';
    ...
    renderTabs() {
        ...
        const showSettings: Record<string, TabSettings> = {
            ...
            [Tab.INCARNATIONS_NEXT]: {
                show: Boolean(isIncarnationNextFeature && UIFactory.renderIncarnationsNextTab()),
            },
...
const mapStateToProps = (state: RootState, routerProps: RouteProps) => {
    ...
    return {
        ...
        isIncarnationNextFeature: selectIsIncarnationNextFeature(state),
    };
};
