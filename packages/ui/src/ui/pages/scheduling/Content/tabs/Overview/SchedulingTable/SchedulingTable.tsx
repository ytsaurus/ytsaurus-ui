...
import {getSchedulingTableItems} from '../../../../../../store/selectors/scheduling/scheduling';
...
export type RowData = ReturnType<typeof getSchedulingTableItems>[number];

export function SchedulingTable() {
    const items = useSelector(getSchedulingTableItems);
