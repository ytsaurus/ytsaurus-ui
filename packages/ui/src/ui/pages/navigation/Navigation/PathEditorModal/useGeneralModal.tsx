...
type Props = {
	...
	abortRequests: () => void
	pathTo: string
	handleAction: (newPath: string, checkboxesValue: typeof DEFAULT_CHECKBOXES, resetCheckboxes: () => void) => void
}

export const useGeneralModal = ({ inProcess, showError, whatObjectToClose, pathTo, handleAction, closeEditingPopup, abortRequests }: Props) => {
	...
	return { checkboxes, handleConfirmButtonClick, handleApply, handleCancelButtonClick, resetCheckboxes }
}