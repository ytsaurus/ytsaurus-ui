    ...
    const {
        ...
        return {
            ...
            onShowAttributes(evt: React.MouseEvent) {
                metrics.countEvent('navigation_map-node_attributes', 1);
            ...
            onEditAttributes(evt: React.MouseEvent) {
                metrics.countEvent('navigation_map-node_edit_attributes', 1);
            ...
            onDeleteClick(evt: React.MouseEvent) {
                metrics.countEvent('navigation_map-node_delete', 1);
                dispatch(openDeleteModal(item));
                evt.stopPropagation();
            },
            onCopyPathClick(evt: React.MouseEvent) {
                metrics.countEvent('navigation_map-node_copy-path', 1);
                evt.stopPropagation();
            },
