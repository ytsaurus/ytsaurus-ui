import {ArrowUp, CloudArrowUpIn} from '@gravity-ui/icons';
...
export const DragAndDrop = <Formats extends FileFormats>({
    availableFormats,
    error,
    progress,
    file,
    ...
    const {hasUpcomingFile, onDrop, onDragEnter, onDragLeave, onDragOver, onFile} = useDragAndDrop({
        availableFormats,
        progress,
        onFileChange,
        onError,
            ...
            >
                {file ? (
                    ...
                    <div className={block('center')}>
                        <div
                            className={block('uploading-icon', {
