...
import {
    RangeDateSelection as RangeDateSelectionBase,
    type RangeDateSelectionProps as RangeDateSelectionBaseProps,
    type RangeValue,
...
export type RangeDateSelectionProps = Omit<RangeDateSelectionBaseProps, 'value'> & {
    value: RangeValue<DateTime>;
};

export function RangeDateSelection({
    className,
    style,
    hasScaleButtons,
    ...
    return (
        <div className={block(null, className)} style={style}>
            ...
            <RangeDateSelectionBase {...props} className={block('selection')} />
