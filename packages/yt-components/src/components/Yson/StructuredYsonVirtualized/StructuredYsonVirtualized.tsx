...
import {Button, Flex, Icon, SegmentedRadioGroup} from '@gravity-ui/uikit';
import {DialogWrapper as Dialog} from '../../DialogWrapper/DialogWrapper';
// @ts-ignore
...
import {DataTableYTWithScroll} from '../../DataTableYT/DataTableYT';
import * as DT100 from '@gravity-ui/react-data-table';
import {Toolbar, WithStickyToolbar} from '../../WithStickyToolbar';
import ArrowDownToLineIcon from '@gravity-ui/icons/svgs/arrow-down-to-line.svg';
import ArrowUpToLineIcon from '@gravity-ui/icons/svgs/arrow-up-to-line.svg';
...
import {DATA_TABLE_YT_SETTINGS_UNDER_TOOLBAR} from '../../../constants';
...
export class StructuredYsonVirtualized extends React.PureComponent<Props, State> {
                        ...
                        node: (
                            <span className={block('buttons')}>
                                <Button title="Expand all" onClick={this.onExpandAll}>
                                    <Icon data={ArrowDownToLineIcon} size={16} />
                                </Button>
                                &nbsp;&nbsp;
                                <Button onClick={this.onCollapseAll} title="Collapse all">
                                    <Icon data={ArrowUpToLineIcon} size={16} />
                                </Button>
                            </span>
                        ),
                    },
