...
import {Button, Flex, Icon as UIKitIcon, copyTextToClipboard} from '@gravity-ui/uikit';
...
import {type LogErrorFn, useYtComponentsConfig} from '../../context';
                            ...
                            >
                                ...
                                >
                                    <ClipboardButton
                                        ...
                                        onCopy={(_text: string) => {
                                            if (allowRawCopy && shiftKeyRef.current) {
                                                copyTextToClipboard(
